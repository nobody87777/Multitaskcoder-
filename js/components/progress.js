...
export function calculateLanguageProgress(language, state) {
  ...
  // Calculate percentage out of total items for this language (~50 typing + ~50 quiz + ~50 debug + ~32 lessons = ~182 items)
  return Math.min(100, Math.round((totalCompleted / 182) * 100));
}
